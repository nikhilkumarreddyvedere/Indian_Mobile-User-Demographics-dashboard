...
with open(data_path + '/geojson/India_geo.json') as data_file:    
...
def get_data():
    ...
    ev = pd.read_sql('SELECT * FROM user_data', con=db_connection)
...
cache = MemcachedCache(['0.0.0.0:5000'])
